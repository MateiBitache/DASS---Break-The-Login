...
def load_settings() -> AppSettings:
    # Production Configuration: Strong cryptographic secret and strict 1-hour expiration
    jwt_secret = os.getenv(
        "AUTHX_SECURITY_JWT_SECRET",
        "7f3e9c8a2b1d4f6e8c9a0b2d4e6f8a9b7f3e9c8a2b1d4f6e8c9a0b2d4e6f8a9b",
    )
